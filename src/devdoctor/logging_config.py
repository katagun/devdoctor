...
# The single logger namespace every devdoctor module logs under. Module
...
_HANDLER_MARKER = "_devdoctor_handler"
...
def configure_logging(verbose: bool) -> None:
    """Attach a stderr handler to the ``devdoctor`` logger.

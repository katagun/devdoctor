...
export function DiskUsageBar() {
  ...
  if (isError) {
    return (
      <div className="text-[10px] font-mono text-text-muted" title="disk usage lookup failed">
        disk · —
      </div>
    );
  }
  if (!data) {
    return <div className="text-[10px] font-mono text-text-muted">disk · …</div>;
  }
  ...
  return (
    ...
    >
      <span className="text-text-muted uppercase tracking-widest text-[9px]">disk</span>
      <div
